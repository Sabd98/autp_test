...
export function UserForm({ open, onOpenChange, onSubmit, initialData, isEdit, fieldErrors = {} }: UserFormProps) {
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            {isEdit ? 'Ubah informasi pengguna' : 'Isi formulir untuk membuat pengguna baru'}
          </DialogDescription>
        </DialogHeader>
        ...
        <div className="space-y-4 py-4">
          ...
          <div>
            ...
            />
            {getFieldError('password_confirmation') && <p className="text-xs text-red-500 mt-1">{getFieldError('password_confirmation')}</p>}
          </div>
        </div>
        ...
        <DialogFooter>
          ...
          <Button onClick={handleSubmit} disabled={isLoading}>
            {isLoading ? 'Memproses...' : isEdit ? 'Simpan Perubahan' : 'Buat Pengguna'}
          </Button>
        </DialogFooter>
      </DialogContent>
    </Dialog>
